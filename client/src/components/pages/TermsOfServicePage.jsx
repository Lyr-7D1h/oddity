...
export default () => {
  return (
    <Page>
      ...
      <p>Welcome to Oddity Servers!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of Oddity Servers's Website, located at https://oddityservers.com.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Oddity Servers if you do not agree to
      ...
      <p>
        We employ the use of cookies. By accessing Oddity Servers, you agreed to
        use cookies in agreement with the Oddity Servers's Privacy Policy.
      </p>
      ...
      <p>
        Unless otherwise stated, Oddity Servers and/or its licensors own the
        intellectual property rights for all material on Oddity Servers. All
        intellectual property rights are reserved. You may access this from
        Oddity Servers for your own personal use subjected to restrictions set
        in these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from Oddity Servers</li>
        <li>Sell, rent or sub-license material from Oddity Servers</li>
        <li>Reproduce, duplicate or copy material from Oddity Servers</li>
        <li>Redistribute content from Oddity Servers</li>
      </ul>
      ...
      <p>
        ...
        Oddity Servers does not filter, edit, publish or review Comments prior
        to their presence on the website. Comments do not reflect the views and
        opinions of Oddity Servers,its agents and/or affiliates. Comments
        reflect the views and opinions of the person who post their views and
        opinions. To the extent permitted by applicable laws, Oddity Servers
      ...
      <p>
        Oddity Servers reserves the right to monitor all Comments and to remove
      ...
      <p>
        You hereby grant Oddity Servers a non-exclusive license to use,
      ...
      <p>
        ...
        the hyperlink compensates the absence of Oddity Servers; and (d) the
      ...
      <p>
        ...
        e-mail to Oddity Servers. Please include your name, your organization
      ...
      <p>
        No use of Oddity Servers's logo or other artwork will be allowed for

    ...
    <Page>
      <Card>
        ...
        <p>
          ...
          use of Oddity Servers's Website, located at https://oddityservers.com.
        </p>

        <p>
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use Oddity Servers if you do not agree
        ...
        <p>
          We employ the use of cookies. By accessing Oddity Servers, you agreed
          to use cookies in agreement with the Oddity Servers's Privacy Policy.
        </p>
        ...
        <p>
          ...
          and opinions of Oddity Servers,its agents and/or affiliates. Comments
        ...
        <p>
          Oddity Servers reserves the right to monitor all Comments and to
        ...
        <p>
          ...
          sending an e-mail to Oddity Servers. Please include your name, your
